...
namespace modbus
{
    ...
    enum class ModbusMessageParsingResult {
        ...
        REQUEST_NOT_FOR_ME=1,
        OK = 0,
        GENERIC_ERROR = -1,
        FUNCTION_CODE_NOT_SUPPORTED=-2,
        OUT_OF_RANGE=-3,
        CRC_ERROR=-4,
        LENGTH_ERROR=-5,
        WRONG_SLAVE_ID_IN_RESPONSE=-6,
        WRONG_FUNCTION_CODE_IN_RESPONSE=-7,
        SLAVE_REPORTED_PROCESSING_ERROR=-8,
        WRONG_PAYLOAD_SIZE=-9,
        WRONG_BUFFER_SIZE=-10,
    };
