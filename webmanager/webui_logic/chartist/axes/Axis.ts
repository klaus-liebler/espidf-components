...
import type { EventEmitter } from '../event/index';
import { isFalseyButZero } from '../utils/index';
import { createGrid, createLabel } from '../core/index';
...
export abstract class Axis {
  ...
  createGridAndLabels(
    ...
    projectedValues.forEach((projectedValue, index) => {
      const labelValue:any = labelValues[index];
      const labelOffset = {
        x: 0,
        y: 0
      };
