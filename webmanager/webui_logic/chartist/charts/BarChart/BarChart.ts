...
import { AutoScaleAxis, StepAxis, axisUnits } from '../../axes/index';
    ...
    each<AllSeriesTypes[number]>(
      ...
      (series, seriesIndex) => {
        ...
        normalizedData.series[seriesIndex].forEach((value, valueIndex) => {
          const valueX:any = safeHasProperty(value, 'x') && value.x;
          const valueY:any = safeHasProperty(value, 'y') && value.y;
