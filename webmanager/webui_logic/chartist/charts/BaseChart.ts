import type { Data, Options, DataEvent, ResponsiveOptions } from '../core/index';
import type { Svg } from '../svg/index';
import type { BaseChartEventsTypes } from './types';
import { OptionsProvider, optionsProvider } from '../core/index';
import { extend } from '../utils/index';
import { EventListener, AllEventsListener, EventEmitter } from '../event/index';
...
export abstract class BaseChart<TEventsTypes = BaseChartEventsTypes> {
  ...
  private initializeTimeoutId: any = setTimeout(
    () => this.initialize(),
    0
  );
