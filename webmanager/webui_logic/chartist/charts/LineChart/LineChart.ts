import type { Axis } from '../../axes/index';
import type {
  LineChartData,
  LineChartOptions,
...
import { isNumeric, noop, extend, safeHasProperty, each } from '../../utils/index';
import { StepAxis, AutoScaleAxis, axisUnits } from '../../axes/index';
import { monotoneCubic, none } from '../../interpolation/index';
    ...
    each(
      ...
      (series:any, seriesIndex) => {
        ...
        if (seriesOptions.showPoint) {
          path.pathElements.forEach((pathElement: { x?: any; y?: any; data?: any; }) => {
        ...
        if (seriesOptions.showArea && axisY.range) {
          ...
          path
            ...
            .filter((pathSegment: { pathElements: string | any[]; }) => pathSegment.pathElements.length > 1)
            ...
            .forEach((areaPath: { stringify: () => any; clone: () => any; }) => {
