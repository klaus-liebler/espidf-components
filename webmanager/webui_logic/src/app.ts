import { LiveLogItem, Message } from "./generated/webmanager";
...
class AppController implements AppManagement, WebsocketMessageListener {
  ...
  public AddScreenController(nameInNavAndInMain: string, controllerObject: ScreenController) {
    ...
    var w = new ScreenControllerWrapper(nameInNavAndInMain, ControllerState.CREATED, mainElement, controllerObject)
  ...
  public startup() {
    this.AddScreenController("home", new WeblogScreenController(this));
    this.AddScreenController("wifimanager", new WifimanagerController(this));
    this.AddScreenController("systemsettings", new SystemScreenController(this));
