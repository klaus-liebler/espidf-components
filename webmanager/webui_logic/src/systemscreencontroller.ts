import { Mac6, RequestJournal, RequestRestart, RequestSystemData, ResponseSystemData } from "./generated/webmanager";
...
export class SystemScreenController extends ScreenController {
    ...
    onMessage(messageWrapper: MessageWrapper): void {
        ...
        this.insertParameter("Uptime [sec]", sd.secondsUptime());
